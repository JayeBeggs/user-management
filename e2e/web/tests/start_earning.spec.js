...
test.describe('Start Earning Flow', () => {
  test('complete start earning flow after login', async ({ page, browser }) => {
    ...
    // Check if we need to complete Personalise My Products first
    ...
    if (await personaliseButton.count()) {
      ...
      console.log('Personalise My Products flow completed');
    } else {
      console.log('Personalise My Products button not found - user may have already completed this flow');
    }
    
    // Now look for and click the "Start Earning" button
    ...
    try {
      ...
      // Verify the action was successful (this might vary based on your app)
      // You might want to check for a success message, redirect, or other indicator
